...
document.addEventListener('DOMContentLoaded', () => {
  ...
  DevTrailController = globalThis.MarkAIDevTrailController.create({
    elements: {
      ...
      area: document.getElementById('btnDevTrailArea'),
      areaClear: document.getElementById('btnDevTrailAreaClear'),
      ...
      exportAudit: document.getElementById('btnDevTrailExportAudit'),
